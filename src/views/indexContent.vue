        ...
        <el-row>
            <el-card>
                <el-row>
                    <el-col :span="5">
                        <el-image
                                src="https://img12.360buyimg.com/cms/jfs/t1/52390/35/13874/60767/5da9926aEea3fdc3b/a0eb6f6ba283d73e.jpg.webp"></el-image>
                    </el-col>
                    <el-col :span="1">
                        <div class="none"></div>
                    </el-col>
                    <el-col :span="5">
                        <el-image
                                src="https://img11.360buyimg.com/cms/jfs/t8299/104/2106646636/43458/5ae0afba/59c4edd9N192bf8e6.jpg.webp"></el-image>
                    </el-col>
                    <el-col :span="1">
                        <div class="none"></div>
                    </el-col>
                    <el-col :span="6" style="padding: 5px;">
                        <el-row class="customCard">
                            ...
                            <el-row>
                                ...
                                <el-col :span="9">
                                    <el-image
                                            src="https://m.360buyimg.com/mobilecms/s792x762_jfs/t1/26594/5/2411/61467/5c1b7379Eeb30585c/b6255f4f52c80efb.jpg!q70.jpg"></el-image>
                                </el-col>
                                <el-col :span="2">
                                    <div class="none"></div>
                                </el-col>
                                <el-col :span="9">
                                    <el-image
                                            src="https://m.360buyimg.com/mobilecms/s923x1026_jfs/t1/15699/25/2264/220027/5c1b192cE930827a0/2a87823efac91895.jpg!q70.jpg"></el-image>
                                </el-col>
                    ...
                    <el-col :span="6" style="padding: 5px;">
                        <el-row class="customCard">
                            ...
                            <el-row>
                                ...
                                <el-col :span="9">
                                    <el-image
                                            src="https://m.360buyimg.com/mobilecms/s1026x992_jfs/t1/23503/31/2320/177633/5c1b1bd0Eb9f25fba/6c6813d7ec3a1a3f.jpg!q70.jpg"></el-image>
                                </el-col>
                                <el-col :span="2">
                                    <div class="none"></div>
                                </el-col>
